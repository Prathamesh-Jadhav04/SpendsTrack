...
const [isNavigating, setIsNavigating] = useState(false);
  ...
  const getScreenComponent = (screen: Screen) => {
    switch (screen) {
      ...
      case "dashboard":
        return <DashboardScreen onNavigate={handleNavigation} transactions={transactions} user={user} isAdmin={user?.role === "admin"} />;
      case "add-expense":
...
function DashboardScreen({ onNavigate, transactions, user, isAdmin }: { onNavigate: (screen: Screen) => void; transactions: Transaction[]; user?: User | null; isAdmin?: boolean }) {
